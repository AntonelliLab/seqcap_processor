...
def add_arguments(parser):
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Use this flag if you want to disable generation of stats (can be necessary because previous stats files can\'t be found if files are used that were not previously processed with SECAPR) '
    )
